...
export const PLANS: PlanConfig[] = [
  {
    ...
    monthlyLimit: 50,
    unlimited: false,
    allowedTools: ["copertine", "pubblicazione", "triage", "amazon", "blurb", "bio", "promo"],
    firstMonthBonus: STARTER_BONUS_CREDITS,
    recommended: false,
    tagline: "Per iniziare a pubblicare con metodo.",
    features: [
      "Copertine, Pubblicazione, Triage, Amazon Marketplace, Blurb, Bio Autore e Promo Kit",
      "50 utilizzi al mese",
  ...
  },
  {
    ...
    monthlyLimit: 300,
    unlimited: false,
    allowedTools: ["copertine", "pubblicazione", "aplus", "triage", "amazon", "blurb", "bio", "promo"],
    firstMonthBonus: 0,
    recommended: true,
    badge: "PIÙ SCELTO",
    tagline: "Il piano ideale per chi pubblica ogni settimana.",
    features: [
      "Tutti i tool, incluso A+ KDPstudio e Amazon Marketplace",
