...
const title = "Termini e condizioni — OP+studioKdp";
const description =
  "Condizioni d'uso di OP+studioKdp: abbonamenti mensili, crediti di utilizzo, rinnovi e cancellazioni.";
      ...
      <main className="mx-auto max-w-3xl px-4 py-16">
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-muted-foreground">
          <section className="space-y-2">
            ...
            <p>
              OP+studioKdp è una piattaforma in abbonamento che fornisce quattro strumenti per la
